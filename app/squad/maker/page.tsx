...
export const metadata = {
  ...
  description: "FC 온라인 선수를 직접 배치해 나만의 스쿼드를 구성하고 공유할 수 있는 FC Help 스쿼드 메이커입니다.",
};
  ...
  return (
    <main className="min-h-screen bg-[#0f1115] text-white">
      <section className="mx-auto max-w-7xl px-0 py-0 md:px-6 md:py-14">
        ...
        <div className="flex flex-wrap gap-2 px-2 pt-2 md:mt-6 md:px-0 md:pt-0">
          <Link href="/squad" className="rounded-xl border border-white/15 bg-white/[0.03] px-4 py-3 text-center text-sm font-black text-gray-200 transition hover:bg-white/[0.07]">
            ← 스쿼드 홈
          </Link>
